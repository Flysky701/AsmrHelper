...
def _make_plan(
    ...
    *,
    ...
    return PipelineExecutionPlan(
        ...
        separation=StageBinding(kind=StageKind.SEPARATION, provider="demucs", model="htdemucs", enabled=separation),
        asr=StageBinding(kind=StageKind.ASR, provider="faster_whisper", model="faster-whisper-base", enabled=asr),
