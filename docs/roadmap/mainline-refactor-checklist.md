...
- 当前主链路契约：[`../contracts/mainline-v1-contract.md`](../contracts/mainline-v1-contract.md)
- 当前数据参数契约：[`../contracts/mainline-v1-data-parameters.md`](../contracts/mainline-v1-data-parameters.md)
- 主链路执行边界：[`../domains/02-pipeline-executor.md`](../domains/02-pipeline-executor.md)
- 任务生成与调度：[`../domains/03-task-generation-queue.md`](../domains/03-task-generation-queue.md)
- 结果与产物管理：[`../domains/08-result-artifact-index.md`](../domains/08-result-artifact-index.md)
- 预览与人工复核：[`../domains/09-preview-review.md`](../domains/09-preview-review.md)
- 前端结构蓝图：[`../designs/desktop-ui-redesign-blueprint.md`](../designs/desktop-ui-redesign-blueprint.md)
- 总体接口契约：[`../contracts/api-contract.md`](../contracts/api-contract.md)
...
- 先按 [`../contracts/mainline-v1-contract.md`](../contracts/mainline-v1-contract.md) 收束主链路契约
- 再按 [`../contracts/mainline-v1-data-parameters.md`](../contracts/mainline-v1-data-parameters.md) 固定数据参数、默认值和旧字段映射
...
如果某个任务页面开始依赖“额外补字段才能用”，应优先回查 [`../contracts/api-contract.md`](../contracts/api-contract.md)。
