"""
智能字幕生成器 - SubtitleGenerator (canonical location: core/subtitles/generator.py)
            ...
            with pdfplumber.open(str(path)) as pdf:
                ...
                if vertical_mode == "auto" and result_h.strip() and ScriptProcessor.detect_vertical_layout(result_h):
                    ...
                    for page in pdf.pages:
                        ...
                        pages_text_v.append(pt if pt else "")
                    result_v = "\n\n".join(pt for pt in pages_text_v if pt.strip())
