...
1. [总体进度状态](roadmap/overall-progress-status.md)：当前阶段、最新验证和剩余边界。
2. [后端能力事实清单](roadmap/backend-capability-baseline.md)：区分已实现、环境可执行、真实验收和受限能力。
3. [当前源代码基线](roadmap/current-source-baseline.md)：判断当前代码结构与主路径。
...
[最终验收矩阵（2026-08-07）](roadmap/final-acceptance-2026-08-07.md)是带日期的验收快照，用于追溯，不覆盖更新后的事实文档。
...
以下只作为历史快照，不再进入当前执行顺序：

- [2026-07-23 架构审计](archived/roadmap/current-architecture-and-doc-audit-2026-07-23.md)
- [旧 Phase 2 收尾计划](archived/plans/phase-2-legacy-core-replacement.md)
- [旧主链路检查清单](archived/plans/mainline-refactor-checklist.md)
- [早期重构架构草案](archived/plans/refactor-architecture-draft.md)
