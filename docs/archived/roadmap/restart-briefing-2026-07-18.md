...
> 本文已归档，只保留 2026-07-18 的恢复判断，不代表当前接口状态。2026-07-24 起只支持 V1 新客户端；当前执行请优先阅读 [当前架构与文档审计](../../roadmap/current-architecture-and-doc-audit-2026-07-23.md) 和 [当前源码基线](../../roadmap/current-source-baseline.md)。
...
4. [Phase 2 后段收尾计划](../../roadmap/phase-2-legacy-core-replacement.md)：各切片的具体范围和验收标准。
